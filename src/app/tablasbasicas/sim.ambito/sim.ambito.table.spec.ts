...
describe('SimAmbito_Table', () => {
    let component: SimAmbitoTable;
    let fixture: ComponentFixture<SimAmbitoTable>;
    ...
    beforeEach(() => {
        ...
        fixture = TestBed.createComponent(SimAmbitoTable);
    ...
    it('should display a rows', () => {
        ...
        mockService.rows.push(new SimAmbitoModel(rowBase));
        mockService.rows.push(new SimAmbitoModel(rowBase));
    ...
    it('should display a Dialog for Add', () => {
        ...
        fixture.whenStable().then(() => {
            ...
            fixture.whenStable().then(() => {
                ...
                expect(addDialogElement.text).toBe('Ambito.SIM>');
            });
        });
    });
