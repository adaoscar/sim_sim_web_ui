...
describe('SimOcupacion_Table', () => {
    let component: SimOcupacionTable;
    let fixture: ComponentFixture<SimOcupacionTable>;
    ...
    beforeEach(() => {
        ...
        fixture = TestBed.createComponent(SimOcupacionTable);
    ...
    it('should display a rows', () => {
        ...
        mockService.rows.push(new SimOcupacionModel(rowBase));
        mockService.rows.push(new SimOcupacionModel(rowBase));
    ...
    it('should display a Dialog for Add', () => {
        ...
        fixture.whenStable().then(() => {
            ...
            fixture.whenStable().then(() => {
                ...
                expect(addDialogElement.text).toBe('Ocupacion.SIM>');
            });
        });
    });
