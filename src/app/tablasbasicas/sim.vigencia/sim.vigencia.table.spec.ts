...
describe('SimVigencia_Table', () => {
    let component: SimVigenciaTable;
    let fixture: ComponentFixture<SimVigenciaTable>;
    ...
    beforeEach(() => {
        ...
        fixture = TestBed.createComponent(SimVigenciaTable);
    ...
    it('should display a rows', () => {
        ...
        mockService.rows.push(new SimVigenciaModel(rowBase));
        mockService.rows.push(new SimVigenciaModel(rowBase));
    ...
    it('should display a Dialog for Add', () => {
        ...
        fixture.whenStable().then(() => {
            ...
            fixture.whenStable().then(() => {
                ...
                expect(addDialogElement.text).toBe('Vigencia.SIM>');
            });
        });
    });
