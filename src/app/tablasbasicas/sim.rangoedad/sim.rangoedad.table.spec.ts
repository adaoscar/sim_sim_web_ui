...
describe('SimRangoEdad_Table', () => {
    let component: SimRangoEdadTable;
    let fixture: ComponentFixture<SimRangoEdadTable>;
    ...
    beforeEach(() => {
        ...
        fixture = TestBed.createComponent(SimRangoEdadTable);
    ...
    it('should display a rows', () => {
        ...
        mockService.rows.push(new SimRangoEdadModel(rowBase));
        mockService.rows.push(new SimRangoEdadModel(rowBase));
    ...
    it('should display a Dialog for Add', () => {
        ...
        fixture.whenStable().then(() => {
            ...
            fixture.whenStable().then(() => {
                ...
                expect(addDialogElement.text).toBe('RangoEdad.SIM>');
            });
        });
    });
