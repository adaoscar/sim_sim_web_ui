...
describe('SimTipoDecision_Table', () => {
    let component: SimTipoDecisionTable;
    let fixture: ComponentFixture<SimTipoDecisionTable>;
    ...
    beforeEach(() => {
        ...
        fixture = TestBed.createComponent(SimTipoDecisionTable);
    ...
    it('should display a rows', () => {
        ...
        mockService.rows.push(new SimTipoDecisionModel(rowBase));
        mockService.rows.push(new SimTipoDecisionModel(rowBase));
    ...
    it('should display a Dialog for Add', () => {
        ...
        fixture.whenStable().then(() => {
            ...
            fixture.whenStable().then(() => {
                ...
                expect(addDialogElement.text).toBe('TipoDecision.SIM>');
            });
        });
    });
