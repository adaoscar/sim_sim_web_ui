...
describe('SimAplicacion_Table', () => {
    let component: SimAplicacionTable;
    let fixture: ComponentFixture<SimAplicacionTable>;
    ...
    beforeEach(() => {
        ...
        fixture = TestBed.createComponent(SimAplicacionTable);
    ...
    it('should display a rows', () => {
        ...
        mockService.rows.push(new SimAplicacionModel(rowBase));
        mockService.rows.push(new SimAplicacionModel(rowBase));
    ...
    it('should display a Dialog for Add', () => {
        ...
        fixture.whenStable().then(() => {
            ...
            fixture.whenStable().then(() => {
                ...
                expect(addDialogElement.text).toBe('Aplicacion.SIM>');
            });
        });
    });
