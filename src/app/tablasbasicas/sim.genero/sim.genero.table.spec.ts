...
describe('SimGenero_Table', () => {
    let component: SimGeneroTable;
    let fixture: ComponentFixture<SimGeneroTable>;
    ...
    beforeEach(() => {
        ...
        fixture = TestBed.createComponent(SimGeneroTable);
    ...
    it('should display a rows', () => {
        ...
        mockService.rows.push(new SimGeneroModel(rowBase));
        mockService.rows.push(new SimGeneroModel(rowBase));
    ...
    it('should display a Dialog for Add', () => {
        ...
        fixture.whenStable().then(() => {
            ...
            fixture.whenStable().then(() => {
                ...
                expect(addDialogElement.text).toBe('Genero.SIM>');
            });
        });
    });
