...
describe('SimPeriodoDias_Table', () => {
    let component: SimPeriodoDiasTable;
    let fixture: ComponentFixture<SimPeriodoDiasTable>;
    ...
    beforeEach(() => {
        ...
        fixture = TestBed.createComponent(SimPeriodoDiasTable);
    ...
    it('should display a rows', () => {
        ...
        mockService.rows.push(new SimPeriodoDiasModel(rowBase));
        mockService.rows.push(new SimPeriodoDiasModel(rowBase));
    ...
    it('should display a Dialog for Add', () => {
        ...
        fixture.whenStable().then(() => {
            ...
            fixture.whenStable().then(() => {
                ...
                expect(addDialogElement.text).toBe('PeriodoDias.SIM>');
            });
        });
    });
