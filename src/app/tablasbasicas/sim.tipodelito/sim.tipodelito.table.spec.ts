...
describe('SimTipoDelito_Table', () => {
    let component: SimTipoDelitoTable;
    let fixture: ComponentFixture<SimTipoDelitoTable>;
    ...
    beforeEach(() => {
        ...
        fixture = TestBed.createComponent(SimTipoDelitoTable);
    ...
    it('should display a rows', () => {
        ...
        mockService.rows.push(new SimTipoDelitoModel(rowBase));
        mockService.rows.push(new SimTipoDelitoModel(rowBase));
    ...
    it('should display a Dialog for Add', () => {
        ...
        fixture.whenStable().then(() => {
            ...
            fixture.whenStable().then(() => {
                ...
                expect(addDialogElement.text).toBe('TipoDelito.SIM>');
            });
        });
    });
