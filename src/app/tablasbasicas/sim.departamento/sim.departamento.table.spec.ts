...
describe('SimDepartamento_Table', () => {
    let component: SimDepartamentoTable;
    let fixture: ComponentFixture<SimDepartamentoTable>;
    ...
    beforeEach(() => {
        ...
        fixture = TestBed.createComponent(SimDepartamentoTable);
    ...
    it('should display a rows', () => {
        ...
        mockService.rows.push(new SimDepartamentoModel(rowBase));
        mockService.rows.push(new SimDepartamentoModel(rowBase));
    ...
    it('should display a Dialog for Add', () => {
        ...
        fixture.whenStable().then(() => {
            ...
            fixture.whenStable().then(() => {
                ...
                expect(addDialogElement.text).toBe('Departamento.SIM>');
            });
        });
    });
