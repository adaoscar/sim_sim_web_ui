...
describe('SimUsuario_Table', () => {
    let component: SimUsuarioTable;
    let fixture: ComponentFixture<SimUsuarioTable>;
    ...
    beforeEach(() => {
        ...
        fixture = TestBed.createComponent(SimUsuarioTable);
    ...
    it('should display a rows', () => {
        ...
        mockService.rows.push(new SimUsuarioModel(rowBase));
        mockService.rows.push(new SimUsuarioModel(rowBase));
    ...
    it('should display a Dialog for Add', () => {
        ...
        fixture.whenStable().then(() => {
            ...
            fixture.whenStable().then(() => {
                ...
                expect(addDialogElement.text).toBe('Usuario.SIM>');
            });
        });
    });
