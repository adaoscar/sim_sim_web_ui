pipeline {
    ...
    environment {       
        ...
        def ACCOUNT_NAME = "integracionsim"
        def ACCOUNT_KEY = "vya5TtAkdNsG/lhh7EQemB8++bxCWlSmZdpJeiIhVI2QW7Oar1v4GM9SuT8BkFv0mnS2cQngJkazGhkW3Hqstw=="
